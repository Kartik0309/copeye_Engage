...
def mask_detect():
	...
	prototxtPath = os.path.join(os.getcwd(),'mask_detection','face_detector','deploy.prototxt')
	weightsPath = os.path.join(os.getcwd(),'mask_detection','face_detector',
		'res10_300x300_ssd_iter_140000.caffemodel')
	faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)

	# load the face mask detector model from disk
	print("[INFO] loading face mask detector model...")
	maskNet = load_model(os.path.join(os.getcwd(),'mask_detection',args["model"]))
